...
export default function SkillTreeDashboard() {
  ...
  if (!ready) {
    return (
      <div className="st-page-enter" style={{ display: "grid", gap: 26 }}>
        <div className="st-card" style={{ padding: 24 }}>
          <div className="st-skeleton" style={{ width: 160, height: 14 }}>x</div>
          <div className="st-skeleton" style={{ width: 260, height: 30, marginTop: 10 }}>x</div>
          <div className="st-skeleton" style={{ width: "100%", maxWidth: 420, height: 11, marginTop: 20, borderRadius: 9999 }}>x</div>
        </div>
      </div>
    );
  }
